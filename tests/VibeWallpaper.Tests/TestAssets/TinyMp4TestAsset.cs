...
internal static class TinyMp4TestAsset
{
    // Deterministic one-frame H.264 MP4 test pattern (8x8, positive media duration).
    // Embedded so tests materialize only disposable copies and never rewrite a checked-in media source.
